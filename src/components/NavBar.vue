...
<nav
  class="flex-no-wrap relative flex w-full items-center justify-between bg-[#FBFBFB] py-2 shadow-md shadow-black/5  dark:shadow-black/10 lg:flex-wrap lg:justify-start lg:py-4">
  <div class="flex w-full flex-wrap items-center justify-between px-3">
    ...
    <div class="relative flex items-center">
      ...
      <a
          ...
          <!-- User avatar -->
          {{ userRole  }}
          <ph-user :size="32" color="#D0BFFF" weight="fill" />
